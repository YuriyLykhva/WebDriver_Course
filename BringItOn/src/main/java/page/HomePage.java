...
public class HomePage extends BasePage {
    ...
    private WebElement inputPasteTextField;
    ...
    public HomePage openPage() {
        ...
        WaiterWrapperClass.waitForElement(driver, inputPasteTextField);
        return this;
    }

    public void sendTextToNewPaste(String text) {
        inputPasteTextField.click();
        inputPasteTextField.sendKeys(text);
    }
